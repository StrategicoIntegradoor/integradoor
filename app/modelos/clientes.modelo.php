...
class ModeloClientes{
	...
	static public function mdlIngresarCliente($tabla, $datos){
		...
		$stmt = Conexion::conectar()->prepare("INSERT INTO $tabla(cli_codigo, cli_num_documento, cli_nombre, cli_apellidos, cli_fch_nacimiento, cli_genero, cli_telefono, 
																	cli_email, cli_estado, id_tipo_documento, id_estado_civil) 
												VALUES (:codigo, :documento, :nombre, :apellido, :nacimiento, :genero, :telefono, :email, :estado, :tipo_documento, :estado_civil)");
	...
	static public function mdlMostrarClientes($tabla, $tabla2, $tabla3, $tabla4, $tabla5, $item, $valor){
		...
		if($item != null){
			...
			if($item == 'id_cliente' || $item == 'cli_num_documento'){
