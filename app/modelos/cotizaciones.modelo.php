...
class ModeloCotizaciones{
		...
		if($item != null){
			...
			if($item == 'id_cotizacion'){
				...
				$stmt = Conexion::conectar()->prepare("SELECT * FROM $tabla, $tabla2, $tabla3, $tabla4, $tabla5, $tabla6 
														...
														AND $tabla2.id_estado_civil = $tabla4.id_estado_civil AND $tabla.id_cotizacion = :$item");
	...
	static public function mdlRangoFechasCotizaciones($tabla, $tabla2, $tabla3, $tabla4, $tabla5, $fechaInicialCotizaciones, $fechaFinalCotizaciones){
			
		$condicion = "";
		if($_SESSION["rol"] != 1){ $condicion = "AND $tabla.id_usuario = :idUsuario"; }
		...
		if($fechaInicialCotizaciones == null){
			...
			$stmt = Conexion::conectar()->prepare("SELECT * FROM $tabla, $tabla2, $tabla3, $tabla4, $tabla5 WHERE $tabla.id_cliente = $tabla2.id_cliente
													...
													AND $tabla2.id_estado_civil = $tabla4.id_estado_civil $condicion");
			...
			$stmt = Conexion::conectar()->prepare("SELECT * FROM $tabla, $tabla2, $tabla3, $tabla4, $tabla5 WHERE $tabla.id_cliente = $tabla2.id_cliente
													AND $tabla.id_usuario = $tabla5.id_usuario AND $tabla2.id_tipo_documento = $tabla3.id_tipo_documento 
													AND $tabla2.id_estado_civil = $tabla4.id_estado_civil AND cot_fch_cotizacion LIKE '%$fechaFinalCotizaciones%' $condicion");
			...
			if($fechaFinalCotizacionesMasUno == $fechaActualMasUno){
				...
				$stmt = Conexion::conectar()->prepare("SELECT * FROM $tabla, $tabla2, $tabla3, $tabla4, $tabla5 WHERE $tabla.id_cliente = $tabla2.id_cliente
														...
														BETWEEN '$fechaInicialCotizaciones' AND '$fechaFinalCotizacionesMasUno' $condicion");
				...
				$stmt = Conexion::conectar()->prepare("SELECT * FROM $tabla, $tabla2, $tabla3, $tabla4, $tabla5 WHERE $tabla.id_cliente = $tabla2.id_cliente
														AND $tabla.id_usuario = $tabla5.id_usuario AND $tabla2.id_tipo_documento = $tabla3.id_tipo_documento 
														AND $tabla2.id_estado_civil = $tabla4.id_estado_civil AND cot_fch_cotizacion 
														BETWEEN '$fechaInicialCotizaciones' AND '$fechaFinalCotizaciones' $condicion");
